...
from misc import is_in, delete_indices, dictionary_of_m_overlaps_of_n_intervals, flatten, has_overlap
    ...
    while len(count_two) >= 1 or number_of_traces != len(traces):
        ...
        while go_next:
            ...
            if not guided:
                ...
                ## TODO implement version where these three traces would be shown so that user can handpick which to delete
                raise NotImplementedError("I am sorry Dave. I am afraid I cannot do that.")

            duplet = [trace1, trace2, trace3]
            duplet_indices = list(pick_key2)
            del duplet[min_len_index]
            del duplet_indices[min_len_index]
            pick_key2 = duplet_indices
            trace1 = duplet[0]
            trace2 = duplet[1]
            del duplet
            ...
            distances = compare_two_traces(trace1, trace2, pick_key2[0], pick_key2[1],
            ...
            if distances is not None and any(
                ...
                to_merge = True
                merge_two_overlapping_traces(trace1, trace2, pick_key2[0], pick_key2[1],
            ...
            if show:
                try:
                    scatter_detection(traces, whole_frame_range,
                                      subtitle=f"after merging overlapping traces {pick_key2[0]} of id {trace1.trace_id} and {pick_key2[1]} of id {trace2_id}.")
