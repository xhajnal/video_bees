...
def run(is_first_run=None):
    ...
    analyse("../data/Video_tracking/190903/20190903_172942424_1BEE_generated_20210520_073610_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190906
    # 2 -> 2 -> 1 *
    analyse("../data/Video_tracking/190906/20190906_152940727_1BEE_generated_20210607_101247_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190918
    # 79 -> 60 -> 1 *
    analyse("../data/Video_tracking/190918/20190918_111016982_1BEE_generated_20210910_081829_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    analyse("../data/Video_tracking/190924/20190924_111059331_1BEE_generated_20210916_090912_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190926
    # 24 -> 10 -> 1 *
    analyse("../data/Video_tracking/190926/20190926_122135161_1BEE_generated_20210924_100636_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190928
    # 3 -> 3 -> 1 *
    analyse("../data/Video_tracking/190928/20190928_163456673_1BEE_generated_20211011_071038_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    analyse("../data/Video_tracking/190930/20190930_112905317_1BEE_generated_20211019_103540_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 5 -> 3 -> 1 *
    analyse("../data/Video_tracking/191003/20191003_131823429_1BEE_generated_20220103_114647_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 9 -> 8 -> 1 *
    analyse("../data/Video_tracking/191007/20191007_151826322_1BEE_generated_20220105_091320_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 109 -> 55 -> 1 *
    analyse("../data/Video_tracking/191008/20191008_151959136_1BEE_generated_20220107_074215_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 191014
    # 378 -> 290 -> 1 *
    analyse("../data/Video_tracking/191014/20191014_160829309_1BEE_generated_20220110_083510_nn.csv", 1, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 55 -> 46 -> 21
    analyse("../data/Video_tracking/190823/20190823_154249666_2BEES_generated_20210510_095112_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190904
    # 1016 -> 748 -> 637
    analyse("../data/Video_tracking/190904/20190904_113737340_2BEES_generated_20210521_065405_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 257 -> 162 -> 58
    analyse("../data/Video_tracking/190905/20190905_120614441_2BEES_generated_20210528_103143_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190916
    # 488 -> 414 -> 161
    analyse("../data/Video_tracking/190916/20190916_123747096_2BEES_generated_20210608_091639_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 554 -> 335 -> 16
    analyse("../data/Video_tracking/190925/20190925_143533237_2BEES_generated_20210924_100804_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 153 -> 117 -> 49
    analyse("../data/Video_tracking/191001/20191001_144417877_2BEES_generated_20211029_092222_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 86 -> 73 -> 22
    analyse("../data/Video_tracking/191008/20191008_163427285_2BEES_generated_20220107_090018_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 825 -> 632 -> 138
    analyse("../data/Video_tracking/191011/20191011_152233987_2BEES_generated_20220107_104708_nn.csv", 2, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 379 -> 266 -> 223
    analyse("../data/Video_tracking/190823/20190823_155506355_5BEES_generated_20210507_092606_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 822 -> 576 -> 339
    analyse("../data/Video_tracking/190904/20190904_160843461_5BEES_generated_20210521_105526_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190916
    # 1434 -> 1013 -> 532
    analyse("../data/Video_tracking/190916/20190916_113158422_5BEES_generated_20210608_081108_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)

    # 548 -> 418 -> 159
    analyse("../data/Video_tracking/190916/20190916_124925687_5BEES_generated_20210609_101547_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)

    # 1015 -> 893 -> 276
    analyse("../data/Video_tracking/190916/20190916_151445887_5BEES_generated_20210611_081733_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # 834 -> 696 -> 208
    analyse("../data/Video_tracking/190930/20190930_140834155_5BEES_generated_20211020_104342_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 191003
    # 1417 -> 939 -> 695
    analyse("../data/Video_tracking/191003/20191003_103917347_5BEES_generated_20220103_105438_nn.csv", 5, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190822
    # 701 -> 506 -> 326
    analyse("../data/Video_tracking/190822/20190822_115819107_7BEE_generated_20210504_064122_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)

    ## 190823
    # 477 -> 370 -> 181
    analyse("../data/Video_tracking/190823/20190823_124111790_7BEES_generated_20210507_070601_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)

    # 895 -> 638 -> 353
    analyse("../data/Video_tracking/190823/20190823_161115188_7BEES_generated_20210507_093529_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)

    ## 190903
    # 1787 -> ->
    analyse("../data/Video_tracking/190903/20190903_125405366_7BEES_generated_20210511_101622_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # -> ->
    analyse("../data/Video_tracking/190904/20190904_162106341_7BEES_generated_20210525_094920_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # -> ->
    analyse("../data/Video_tracking/190906/20190906_160755199_7BEES_generated_20210607_103715_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)

    ## 190916
    # -> ->
    analyse("../data/Video_tracking/190916/20190916_114706187_7BEES_generated_20210608_083833_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190927
    # -> ->
    analyse("../data/Video_tracking/190927/20190927_102553712_7BEES_generated_20210929_094812_nn.csv", 7, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # -> ->
    analyse("../data/Video_tracking/190903/20190903_170217904_10BEES_generated_20210512_071725_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # -> ->
    analyse("../data/Video_tracking/190904/20190904_163324719_10BEES_generated_20210525_100838_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)

    ## 190905
    # -> ->
    analyse("../data/Video_tracking/190905/20190905_110548502_10BEES_generated_20210527_094614_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)

    ## 190906
    # -> ->
    analyse("../data/Video_tracking/190906/20190906_150041160_10BEES_generated_20210601_071145_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)

    ## 190916
    # -> ->
    analyse("../data/Video_tracking/190916/20190916_120207930_10BEES_generated_20210608_085327_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190922
    # -> ->
    analyse("../data/Video_tracking/190922/20190922_125541361_10BEES_generated_20210916_083116_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190927
    # -> ->
    analyse("../data/Video_tracking/190927/20190927_103759768_10BEES_generated_20210929_104342_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # -> ->
    analyse("../data/Video_tracking/191017/20191017_132743751_10BEES_generated_20220121_115258_nn.csv", 10, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190822
    # -> ->
    analyse("../data/Video_tracking/190822/20190822_122407809_15BEE_generated_20210803_085008_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)

    ## 190823
    # -> ->
    analyse("../data/Video_tracking/190823/20190823_163934743_15BEES_generated_20210510_082044_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)

    ## 190903
    # -> ->
    analyse("../data/Video_tracking/190903/20190903_132435095_15BEES_generated_20210511_063736_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190904
    # -> ->
    analyse("../data/Video_tracking/190904/20190904_123252421_15BEES_generated_20210521_063745_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190905
    # -> ->
    analyse("../data/Video_tracking/190905/20190905_111848284_15BEES_generated_20210527_103530_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)
    ...
    ## 190920
    # -> ->
    analyse("../data/Video_tracking/190920/20190920_110628291_15BEES_generated_20210909_095322_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)
    ...
    # -> ->
    analyse("../data/Video_tracking/191001/20191001_141957735_15BEES_generated_20211028_095546_nn.csv", 15, has_tracked_video=True, is_first_run=is_first_run)
